...
public class BookTest extends BookTestSuper{
	...
	public class TestBookShop {
	    ...
	    public void main(String[] args){
			...
			Book b1 = new Book("Ah'lar Aðacý", "Didem Madak", 20.0, "3418793409");

			HardCopyBook b2 = new HardCopyBook("Sevdadýr", "Arkadaþ Zekai Özger" ,80.0, "3418793410", 34.0, 10.0);
			...
			b4.addDevice();
			EBook b5 = new EBook("Matematik ve Develerle Eþekler", "Ali Nesin", 40.0, "3418793413", 2000.0, "epub");
	        ...
	        HardCopyBook hcb1 = new HardCopyBook("Sýrça Fanus", "Sylvia Plath", 25, "3418793410", 34.0, 10.0);
	        HardCopyBook hcb2 = new HardCopyBook("Yabancý","Albert Camus" ,20.0, "3418793411", 42.0, 10.0);
	        HardCopyBook hcb3 = new HardCopyBook("Mülkiyet Nedir?","Pierre Joseph Proudhon" ,80.0, "3418793410", 34.0, 10.0);
	        HardCopyBook hcb4 = new HardCopyBook("Bulantý","Jean-Paul Sartre" ,30.0, "3418793411", 42.0, 10.0);
	        ...
	        EBook e1 = new EBook("Kalemimin Sapýný Gülle Donattým", "Ferhan Þensoy", 75.0, "3418793412", 200, "epub");
	        EBook e2 = new EBook("Þirince Meydan Muharebelerinin Mufassal Tarihçesi","Sevan Niþanyan" ,125.0, "3418793412", 150, "epub");
